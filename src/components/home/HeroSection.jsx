...
const AI_SCREENING_DASHBOARD_IMAGE = dashMainImg; // Replace with the actual hosted URL of the image above
    ...
    <div className="pt-32 pb-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mt-6 max-w-3xl mx-auto text-xl text-gray-500">
          Let ResumeZai handle resume analysis, job matching, and candidate scoring — so you can focus on what truly matters: <span className="font-semibold">hiring the right talent.</span>
        </p>
