...
export default function CandidatesDashboardPage() {
  ...
  return (
    <Box sx={{ pt: "20px", px: 2, pb: 2 }}>
      ...
      {/* Tab Panels */}
      {activeTab === 0 && <JobDetails jobDetails={jobDetails} />}

      {activeTab === 1 && <CandidatesCards onDataLoaded={setCandidatesData} />}

      {activeTab === 2 && <CandidatesGrid onDataLoaded={setCandidatesData} />}
